...
const CATEGORY_MAPPING = {
  'electronics': {
    keywords: ['điện thoại', 'smartphone', 'iphone', 'android', 'máy tính', 'laptop', 'notebook', 'computer', 'desktop', 'ipad', 'tablet', 'máy ảnh', 'camera', 'smartwatch', 'điện tử', 'công nghệ'],
    name: 'Điện tử',
    icon: '📱'
  },
  'fashion': {
    keywords: ['quần áo', 'áo', 'quần', 'áo khoác', 'áo phông', 'áo sơ mi', 'đầm', 'váy', 'giày', 'dép', 'mỹ phẩm', 'cosmetic', 'makeup', 'phụ kiện', 'trang sức', 'thời trang'],
    name: 'Thời trang',
    icon: '👗'
  },
  'food': {
    keywords: ['thực phẩm', 'chả', 'mực', 'khô', 'ăn vặt', 'đông lạnh', 'tươi', 'rau', 'thịt', 'cá', 'tôm', 'nước', 'rượu', 'đồ ăn'],
    name: 'Thực phẩm',
    icon: '🍔'
  },
  'home': {
        keywords: ['nhà cửa', 'nhà', 'đất', 'phòng trọ', 'căn hộ', 'chung cư', 'villa', 'biệt thự', 'bất động sản', 'nhà đất', 'bán nhà', 'cho thuê nhà', 'cho thuê phòng', 'phòng trọ', 'bán đất'],
    name: 'Nhà cửa',
    icon: '🛋️'
  },
  'vehicles': {
    keywords: ['ô tô', 'xe ô tô', 'car', 'xe máy', 'motorbike', 'motorcycle', 'xe đạp', 'xe điện', 'xe tải', 'xe bus', 'xe van', 'oto'],
    name: 'Xe cộ',
    icon: '🚗'
  },
  'appliances': {
        keywords: ['máy giặt', 'tủ lạnh', 'tv', 'ti vi', 'lò vi sóng', 'bếp', 'nồi', 'lò nướng', 'máy sấy', 'quạt', 'điều hòa', 'kệ', 'ấm', 'bộ dao', 'đồ gia dụng', 'đồ gia dụng', 'gia dụng'],
    name: 'Đồ gia dụng',
    icon: '🏠'
  }
};
...
const CATEGORY_FILTERS = {
  vehicles: {
    label: 'Xe cộ',
    types: [
      { key: 'oto', label: 'Ô tô', keywords: ['ô tô', 'oto', 'xe hơi', 'sedan', 'suv', 'hatchback', 'xe con', 'xe sang', 'offroad', 'crossover'] },
      { key: 'xemay', label: 'Xe máy', keywords: ['xe máy', 'xemay', 'moto', 'motor', 'scooter', 'xe số', 'xe tay ga', 'xe côn'] },
      { key: 'xedien', label: 'Xe điện', keywords: ['xe điện', 'xedien', 'electric', 'ev', 'pin', 'điện', 'tesla', 'vinfast'] },
      { key: 'xedap', label: 'Xe đạp', keywords: ['xe đạp', 'xedap', 'bicycle', 'đạp', 'đạp xe'] },
      { key: 'xetai', label: 'Xe tải', keywords: ['xe tải', 'xetai', 'truck', 'container', 'ben', 'xe ben', 'xe đầu kéo'] }
    ],
    brands: {
      all: ['Tất cả', 'Daewoo', 'Mazda', 'BMW', 'Toyota', 'Nissan', 'Hyundai', 'Chevrolet', 'Honda', 'Suzuki', 'Mercedes', 'VinFast', 'Kia', 'Yamaha', 'Piaggio', 'Tesla'],
      oto: ['Tất cả', 'Daewoo', 'Mazda', 'BMW', 'Toyota', 'Nissan', 'Hyundai', 'Chevrolet', 'Honda', 'Suzuki', 'Mercedes', 'VinFast', 'Kia'],
      xedien: ['Tất cả', 'VinFast', 'Tesla', 'Nissan', 'BMW', 'Toyota', 'Hyundai', 'Kia', 'Honda'],
      xemay: ['Tất cả', 'Honda', 'Suzuki', 'Yamaha', 'Piaggio', 'Kia'],
      xedap: ['Tất cả', 'Giant', 'Trek', 'Specialized', 'Xe đạp'],
      xetai: ['Tất cả', 'Hino', 'Isuzu', 'Hyundai', 'Toyota', 'Daewoo', 'Mercedes']
    }
  },
  electronics: {
    label: 'Điện tử',
    types: [
      { key: 'dienthoai', label: 'Điện thoại', keywords: ['điện thoại', 'smartphone', 'iphone', 'android', 'xiaomi', 'samsung', 'oppo', 'vivo', 'nokia'] },
      { key: 'laptop', label: 'Laptop', keywords: ['laptop', 'macbook', 'notebook', 'dell', 'hp', 'lenovo', 'asus', 'acer'] },
      { key: 'tivi', label: 'Tivi', keywords: ['tv', 'tivi', 'led', 'oled', 'qled', 'smart tv'] },
      { key: 'mayanh', label: 'Máy ảnh', keywords: ['máy ảnh', 'camera', 'canon', 'nikon', 'sony', 'fujifilm'] }
    ],
    brands: {
      all: ['Tất cả', 'Samsung', 'Apple', 'Xiaomi', 'Sony', 'LG', 'Dell', 'HP', 'Lenovo', 'Asus', 'Canon', 'Nikon', 'Panasonic'],
      dienthoai: ['Tất cả', 'Samsung', 'Apple', 'Xiaomi', 'Oppo', 'Vivo', 'Nokia'],
  ...
  fashion: {
    label: 'Thời trang',
    types: [
      { key: 'nam', label: 'Nam', keywords: ['nam', 'quần tây', 'áo sơ mi', 'vest', 'giày nam'] },
      { key: 'nu', label: 'Nữ', keywords: ['nữ', 'váy', 'đầm', 'áo dài', 'giày nữ'] },
      { key: 'giay', label: 'Giày dép', keywords: ['giày', 'dép', 'bốt', 'sandal'] },
      { key: 'phukien', label: 'Phụ kiện', keywords: ['túi', 'mắt kính', 'nón', 'thắt lưng', 'phụ kiện'] }
    ],
    brands: {
      all: ['Tất cả', 'Zara', 'H&M', 'Nike', 'Adidas', 'Converse', 'Gucci', 'Prada', 'Levi’s', 'Uniqlo'],
  ...
  home: {
    label: 'Nhà cửa',
    types: [
      { key: 'noithat', label: 'Nội thất', keywords: ['nội thất', 'bàn', 'ghế', 'giường', 'tủ'] },
      { key: 'trangtri', label: 'Trang trí', keywords: ['trang trí', 'đèn', 'thảm', 'tranh', 'gối'] },
      { key: 'gia dụng', label: 'Gia dụng', keywords: ['gia dụng', 'đồ dùng', 'nồi', 'chảo', 'bếp'] }
    ],
    brands: {
      all: ['Tất cả', 'IKEA', 'Midea', 'Sharp', 'Panasonic', 'Tefal', 'Electrolux'],
  ...
  food: {
    label: 'Thực phẩm',
    types: [
      { key: 'thucpham', label: 'Thực phẩm', keywords: ['thực phẩm', 'đồ ăn', 'hải sản', 'rau', 'thịt', 'trái cây'] },
      { key: 'doanuong', label: 'Đồ uống', keywords: ['nước', 'thức uống', 'cà phê', 'trà', 'nước ngọt'] }
    ],
    brands: {
      all: ['Tất cả', 'Vinamilk', 'TH True Milk', 'Hòa Phát', 'Nestlé', 'Coca-Cola'],
  ...
  appliances: {
    label: 'Đồ gia dụng',
    types: [
      { key: 'bep', label: 'Nhà bếp', keywords: ['bếp', 'lò nướng', 'nồi', 'chảo', 'máy xay'] },
      { key: 'giadung', label: 'Gia dụng', keywords: ['máy giặt', 'tủ lạnh', 'máy lạnh', 'quạt'] },
      { key: 'dieuhoa', label: 'Điều hòa', keywords: ['điều hòa', 'máy lạnh', 'điều hoà'] }
    ],
    brands: {
      all: ['Tất cả', 'Panasonic', 'Electrolux', 'Samsung', 'LG', 'Midea', 'Sharp'],
...
function getCategorySearchText(product) {
    return [product.name, product.categoryName, product.description || ''].join(' ').toLowerCase();
}
...
function sampleMixedProducts(products, count = 33) {
    ...
    for (const p of products) {
        ...
        if (!cat || cat === 'all') {
            cat = mapCategoryFromApi(p.categoryName || p.category || '', p.name || '', p.description || '');
        }
    ...
    products.forEach((product) => {
        ...
        if (rand < 0.30) {
            ...
            minutesAgo = Math.floor(
                (1 + Math.random() * 6) * 24 * 60
            );
        } else if (rand < 0.80) {
            // 20% từ 1-4 tuần
            minutesAgo = Math.floor(
                (7 + Math.random() * 21) * 24 * 60
            );
        } else {
            // 20% từ 1-3 tháng
            minutesAgo = Math.floor(
                (30 + Math.random() * 60) * 24 * 60
            );
        }

        product._postDate = new Date(
...
return products.filter(p => {
    ...
    if (timeRange === 'yesterday') return dDate.getTime() === yesterday.getTime();
...
async function fetchChototProductsRealApi() {
    ...
    const serverProxy = 'http://localhost:3000/api/chotot?limit=200';
    const localProxyAvailable = sessionStorage.getItem('chototLocalProxyAvailable');
    const fallbackProxy = 'https://corsproxy.io/?' + encodeURIComponent('https://gateway.chotot.com/v1/public/ad-listing?cg=1000&page=1&limit=200');
    ...
    async function parseChototResponse(raw) {
        ...
        return ads.map(item => ({
            ...
            category: mapCategoryFromApi(item.category_name || item.category, item.subject || item.title, item.description || item.body || ''),
            categoryName: item.category_name || item.category || 'Khác',
            price: item.price || 0,
            priceString: item.price_string || (item.price ? `${(item.price).toLocaleString('vi-VN')} đ` : '0 đ'),
            image: item.image || item.thumbnail_image || item.thumbnail || 'https://placehold.co/300x200?text=Cho+Tot',
            location: item.area_name || item.region_name || item.location || 'Toàn quốc',
    ...
    if (location.port === '3000') {
        try {
            const resp = await fetch(localProxy, { headers: { 'Accept': 'application/json' } });
            if (resp.ok) {
                const json = await resp.json();
                const ads = json.ads || json;
                const parsed = await parseChototResponse(ads);
                if (parsed.length > 0) {
                    console.log('Loaded from local proxy (cached:', !!json.cached, ')', parsed.length);
    ...
    if (localProxyAvailable !== 'false') {
        try {
            const resp = await fetch(serverProxy, { headers: { 'Accept': 'application/json' } });
            ...
            if (resp.ok) {
                ...
                console.warn('Server proxy returned non-ok status', serverProxy, resp.status);
            }
        } catch (e) {
    ...
    const gatewayUrl = 'https://gateway.chotot.com/v1/public/ad-listing?page=1&limit=200';
...
function filterAndSortProducts() {
    ...
    if (state.selectedCategory !== 'all') {
        ...
        const displayName = CATEGORY_MAPPING[key] ? CATEGORY_MAPPING[key].name.toLowerCase() : '';
        filtered = filtered.filter(p => {
            const isDirectCategory = p.category === key || (p.categoryName && p.categoryName.toLowerCase().includes(displayName));
            const guessed = mapCategoryFromApi(p.categoryName || p.category || '', p.name || '', p.description || '');
...
function renderCategoryFilters() {
    ...
    if (typeContainer) {
        typeContainer.innerHTML = categoryDef.types.map(type => `
    ...
    if (clearButton) {
        clearButton.style.display = state.selectedCategoryType || state.selectedCategoryBrand ? 'inline-flex' : 'none';
    }
}
...
function renderProducts() {
    ...
    if (state.selectedCategory === 'all' && !state.viewAll) {
        toRender = sampleMixedProducts(state.filteredProducts, 33);
    }
    ...
    function inferAttributes(product) {
        ...
        if (kmMatch) attrs.push({k: 'Km', v: kmMatch[1].replace(',', '.') + ' km'});

        // Fuel
        if (text.includes('xăng')) attrs.push({k: 'Nhiên liệu', v: 'Xăng'});
        else if (text.includes('dầu') || text.includes('diesel')) attrs.push({k: 'Nhiên liệu', v: 'Dầu'});

        // Gearbox
        if (text.includes('số tự động') || text.includes('tự động') || /at\b/.test(text)) attrs.push({k: 'Hộp số', v: 'Tự động'});
        else if (text.includes('số sàn') || /mt\b/.test(text)) attrs.push({k: 'Hộp số', v: 'Sàn'});
        ...
        if (attrs.length === 0 && product.time) attrs.push({k: 'Tình trạng', v: product.time});

        return attrs.slice(0,4);
    }

    productsList.innerHTML = toRender.map(product => {
        const attrs = inferAttributes(product);
        const attrsHtml = attrs.map(a => `<li><strong>${a.k}:</strong> ${a.v}</li>`).join('');
        const priceText = product.priceString || (product.price ? `${(product.price).toLocaleString('vi-VN')} đ` : 'Liên hệ');
...
window.showProductDetail = function(productId) {
    const selected = state.products.find(p => String(p.ad_id || p.id) === String(productId));
    if (selected) {
        try {
            sessionStorage.setItem('chototSelectedProduct', JSON.stringify(selected));
        } catch (err) {
            console.warn('Could not store selected product in sessionStorage:', err.message);
        }
    }
...
function showProxyMissingBanner() {
    ...
    msg.innerHTML = `Không kết nối được đến proxy server. Chuyển sang <strong>http://localhost:3000</strong> sau <span id="proxyCountdown">5</span>s...`;
    banner.appendChild(msg);

    const actions = document.createElement('div');
    const openBtn = document.createElement('button');
    openBtn.textContent = 'Mở proxy ngay';
    openBtn.style.marginRight = '8px';
    openBtn.onclick = () => { window.location.href = 'http://localhost:3000'; };

    const stayBtn = document.createElement('button');
    stayBtn.textContent = 'Ở lại';
    stayBtn.onclick = () => { removeProxyBanner(); };
    ...
    let seconds = 5;
    const countdownEl = document.getElementById('proxyCountdown');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (goWebsiteBtn) goWebsiteBtn.addEventListener('click', (e) => {
        e.preventDefault();
        showWebsiteContent();
    });
    ...
    if (infoHomeBtn) infoHomeBtn.addEventListener('click', (e) => {
        e.preventDefault();
        handleInfoHome();
    });
